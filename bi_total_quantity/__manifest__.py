...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    'description': """
    	 Total Number of Items/Quantity odoo app is a powerful tool that helps businesses easily track the number of ordered quantity, number of delivered quantity, and number of invoiced quantity of items in their sale and purchase order, Also can see the number of demand quantity and number of done quantity for inventory.
