            ...
            try:
                if sale_order.shopify_order_status == "fulfilled":
                    sale_order.with_context(
                        log_book_id=log_book.id, order_data_line=order_data_line,
                        log_book=log_book).shipped_order_workflow_ept(sale_order)
        ...
        if "draft" in self.invoice_ids.mapped("state"):
            ...
            for invoice_id in self.invoice_ids:
                ...
                move_reversal = self.env["account.move.reversal"].with_context(
                    ...
                    {'journal_id': invoice_id.journal_id.id, 'date': reverse_move_date, 'refund_method': 'cancel',
